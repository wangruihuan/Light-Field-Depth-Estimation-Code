function uvo = estimate_flow_interface(im1, im2, method, params, initialize) 
addpath('flow_code/utils');
%
addpath('flow_code/utils/@robust_function/');
addpath('flow_code/utils/downloaded/');
addpath('flow_code/utils/flowColorCode/');
addpath('flow_code/utils/mex/');
...
if nargin < 5
    initialize = zeros(size(im1,1),size(im1,2), 2);
end
% Compute flow field
uv  = compute_flow(ope, initialize);
