function [A_sh, b_sh] = reg_shading_harmonics_gradient_term(shading, lighting, shading_confi, LF_parameters)
...
dnx_dx_mat = CONVKERNEL2MATRIX([0 0 0; -1 2 -1; 0 0 0], y_size, x_size);
dny_dx_mat = CONVKERNEL2MATRIX([1 0 -1; 0 0 0; -1 0 1], y_size, x_size);
dnx_dy_mat = CONVKERNEL2MATRIX([1 0 -1; 0 0 0; -1 0 1], y_size, x_size);
dny_dy_mat = CONVKERNEL2MATRIX([0 0 0; -1 2 -1; 0 0 0]', y_size, x_size);

zero_mat = sparse([], [], [], num_pixels, num_pixels);
lx_mat = spdiags(lighting(4)*ones(num_pixels,1), 0, num_pixels, num_pixels);
