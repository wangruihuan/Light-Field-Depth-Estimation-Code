...
%imwrite(initial_depth, ['C:\Users\Pratul\Documents\Shading_Depth\0-NORMALS_REGULARIZATION\output\Initial_Depth\' num2str(i) '.jpg']);

%% Focus Remap
[Angular_Coherence_Mat, angular_use_indices] = angular_coherence(initial_depth, LF_Remap, LF_parameters);

%%Shading Regularization
depth_filt = medfilt2(initial_depth, [11 11], 'symmetric');
...
[Nx, Ny, Nz] = surfnorm(points_x, points_y, depth_filt);
