...
% opts.Dmin: the minimum disparity betwoutput_path =strcat('E:\Spinning-Parallelogram-Operator-master(1)\output\medieval2\','medieval2_',num2str(i),'_',int2str(j));een the border view and the central view; (-2 default)
